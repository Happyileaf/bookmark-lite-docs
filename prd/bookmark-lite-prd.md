...
- 应用设置用于配置全局默认策略，仅超级管理员可修改。
- 用户设置用于配置当前登录用户的个人偏好与个人数据策略，仅当前用户本人可修改。
- 当应用默认值与用户个人偏好冲突时，以用户设置为准；未设置个人偏好时，继承应用默认值。
...
|---|---|---|---|---|---|
| 应用基础信息 | 应用名称 | 文本，2-50 字符 | `Bookmark Lite` | 全应用 | 展示于公开页与管理页头部 |
| 应用基础信息 | 应用描述 | 文本，0-200 字符 | 空 | 全应用 | 展示于公开页简介区域 |
| 应用主题设置 | 界面主题 | 浅色 / 深色 / 跟随系统 | 跟随系统 | 当前用户全站界面 | 对应 6.9.3 |
| 应用数据策略 | 回收站保留期 | 7 天 / 30 天 / 90 天 / 永久保留 | 30 天 | 应用级回收站 | 到期后自动永久删除 |
| 应用数据策略 | 审计日志保留期 | 30 天 / 90 天 / 180 天 / 365 天 | 180 天 | 应用审计日志 | 超过保留期后自动清理 |
...
| 主题设置 | 界面主题 | 浅色 / 深色 / 跟随系统 | 跟随系统 | 当前用户全站界面 | 对应 6.9.3 |
| 个人数据策略 | 回收站保留期 | 7 天 / 30 天 / 90 天 / 永久保留 | 继承应用默认值 | 当前用户个人回收站 | 个人设置值不得超过应用设置允许的最大保留期 |
| 个人数据策略 | 审计日志保留期 | 30 天 / 90 天 / 180 天 / 365 天 | 继承应用默认值 | 当前用户个人审计日志 | 个人设置值不得超过应用设置允许的最大保留期 |
